...
Thank you for taking the time to contribute to Otto.

## Philosophy

Otto is an opinionated product, built on freedom and flexibility: any agent provider, any device, running on your own machine. It is meant to be composable, so you can build the workflow you want. Read more about the product vision [here](docs/product.md).

Given Otto's scope, contributing to it takes a lot of context that is very hard to transfer. That's why product, design, architecture, and workflow decisions are currently all made by the maintainer.
...
> [!IMPORTANT]
> Feature requests have their own issue template. Big ideas belong in a discussion first.
...
## Product discussions go in GitHub Discussions

Open a product discussion in [Discussions](https://github.com/Draek2077/otto-code/discussions), and frame it as a workflow:

- What are you trying to do?
- How do you do it today?
- Where does Otto get in the way?
...
- Fails checks
- Ignores bot reviews
- Adds a feature or design change that wasn't discussed first
...
QA is the main bottleneck of Otto's product development, and it's not just whether the feature works, it's also whether it meets the quality bar.
...
Open a [discussion](https://github.com/Draek2077/otto-code/discussions) and describe what you were trying to do.

### Where do feature requests go?

Use the feature request issue template for a concrete, scoped change. Anything larger starts as a product discussion, framed as a workflow rather than as "can you build X".

### Why didn't my PR get a detailed review?

Writing a review is very time consuming and Otto receives a lot of PRs, I cannot give detailed explanations at volume.
