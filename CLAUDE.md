...
| [docs/activity-stats.md](docs/activity-stats.md)                                   | Activity Stats — daemon-wide usage counter store (`activity-stats.json`), day-bucketed rollups, chokepoints, the `stats.activity.get` RPC, and the app start-screen setting                     |
...
| [projects/suggested-task-visibility/suggested-task-visibility.md](projects/suggested-task-visibility/suggested-task-visibility.md)                         | `spawn_task` no longer fires from models (regression hunt) + card needs colour tints to stand out                                                               |
...
| [projects/worktree-archive-branch-cleanup/worktree-archive-branch-cleanup.md](projects/worktree-archive-branch-cleanup/worktree-archive-branch-cleanup.md) | BUILT uncommitted: archiving a worktree detects → confirms → deletes its leftover local branch (preflight RPC + branchDisposition; merged→delete default)       |
