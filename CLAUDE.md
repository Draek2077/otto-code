...
| ---------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [projects/interface-modes/interface-modes.md](projects/interface-modes/interface-modes.md)                                   | Charter: Interface modes — User vs Developer display depth, chosen on first launch and switchable anytime; device-local `interfaceMode` setting, one `useIsDeveloperMode()` gate, enumerated surface inventory (git/diffs/files/search/terminals hidden in User mode), presentation-only (a lens, not a lock)    |
