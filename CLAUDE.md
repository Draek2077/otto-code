...
| [projects/context-health/context-health.md](projects/context-health/context-health.md)                                         | Charter: daemon scans provider-loaded context files (CLAUDE.md/memory/AGENTS.md), amber chip warns on oversized ones, action = open → AI-compact (reuses AI Refactor) |
