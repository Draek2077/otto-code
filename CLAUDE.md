...
| [projects/computer-use/computer-use.md](projects/computer-use/computer-use.md)                                               | Charter: Computer use — agents see and control the daemon machine's real desktop (screenshot → click/type loop), daemon-native `computer-use` subsystem, layered safety (arming, touch-your-mouse auto-pause), openai-compat vision delivery as Phase 0                                                                                                                                                                                                                                                                                                                                  |
