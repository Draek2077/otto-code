...
| [projects/orchestration-graphs/orchestration-graphs.md](projects/orchestration-graphs/orchestration-graphs.md)                                     | BUILT: user orchestrations — host-level Graph templates, deterministic graph engine, tool-policy binary, New Orchestration dialog, Drawflow designer tab                                                                                                  |
| [projects/first-time-wizard/first-time-wizard.md](projects/first-time-wizard/first-time-wizard.md)                                                 | Charter: full-screen setup wizard (Mode→Providers→Personalities→Teams→Home); absorbs interface-modes charter                                                                                                                                              |
...
| [projects/context-management/context-management.md](projects/context-management/context-management.md)                                             | Charter: full accounting of everything sent before you type (context graph, skills, MCP, memory) + 3-pane Context Management tab; severity as % of model window                                                                                           |
...
| [projects/duplicate-base-workspaces/duplicate-base-workspaces.md](projects/duplicate-base-workspaces/duplicate-base-workspaces.md)                 | Investigation: duplicate non-worktree workspaces share one folder and therefore one branch — allowed, or steer to worktrees?                                                                                                                              |
