...
| [projects/team-personality-resolution/team-personality-resolution.md](projects/team-personality-resolution/team-personality-resolution.md)         | Team-chat personality still latches stale/base model; sentinel-id bug fixed 0.6.6, 4 load-order latches remain                                                  |
...
| [projects/git-file-history/git-file-history.md](projects/git-file-history/git-file-history.md)                                                     | Charter: JetBrains-grade git investigation on a file/selection — history, per-commit diffs, blame, original author                                              |
| [projects/workspace-scripts-terminals/workspace-scripts-terminals.md](projects/workspace-scripts-terminals/workspace-scripts-terminals.md)         | Scripts must open a visible terminal tab and run in the workspace root; Run Scripts button lost in the title bar                                                |
...
| [projects/voice-cue-waiting/voice-cue-waiting.md](projects/voice-cue-waiting/voice-cue-waiting.md)                                                 | Charter: 4th cue moment "waiting" — turn done but sub-agents still running; plumbing is mechanical, the trigger is the work                                     |
| [projects/matrix-text-effect/matrix-text-effect.md](projects/matrix-text-effect/matrix-text-effect.md)                                             | Charter: "matrix" effect needs a per-glyph renderer branch; wave + flames shipped as registry entries                                                           |
| [projects/vertical-tab-resize/vertical-tab-resize.md](projects/vertical-tab-resize/vertical-tab-resize.md)                                         | Charter: drag-splitter width for the vertical tab rail, one saved width for all rails                                                                           |
