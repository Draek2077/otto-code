...
| ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Anything preview- or browser-tool-related                                             | [docs/preview.md](docs/preview.md) — token economy, guardrail-bearing tool descriptions, daemon-enforced tab binding                     |
