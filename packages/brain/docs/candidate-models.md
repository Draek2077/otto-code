...
| **Ornith 1.0 35B** (MoE)                 | Q4_K_M  | ~20GB | Vision-capable all-rounder for complex tasks that mix text, code, and images.                              |
| **Mistral Small 3.2 24B**                | Q4_K_M  | ~14GB | Fast instruction follower for documents, structured data, and code.                                        |
...
| Model              | Quant  | ~VRAM | Notes                                                                           |
| ------------------ | ------ | ----- | ------------------------------------------------------------------------------- |
| **DeepSeek OCR 2** | Q4_K_M | ~2GB  | Compact vision model for extracting text and structure from documents and PDFs. |
