...
const existingProject = join(await mkdtemp(join(tmpdir(), "otto-open-project-")), "project");
...
const previousDesktopCli = process.env.OTTO_DESKTOP_CLI;
process.env.OTTO_DESKTOP_CLI = "1";
...
process.env.OTTO_DESKTOP_CLI = previousDesktopCli;
