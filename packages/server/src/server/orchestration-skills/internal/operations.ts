...
/** Every name Otto owns on disk: what it ships now plus what it used to ship. */
...
export async function getSkillsStatus(
  ...
  if (!hasInstalledOttoSkill(disks)) return { state: "not-installed", ops, available, installed };
