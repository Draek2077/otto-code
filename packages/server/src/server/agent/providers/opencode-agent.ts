...
const OPENCODE_SESSION_ENV_KEYS = new Set(["OTTO_AGENT_ID", "OTTO_AGENT_CWD"]);
...
export class OpenCodeAgentClient implements AgentClient {
  ...
  constructor(
    ...
    this.capabilities = {
      ...
      ...(this.bridge ? { supportsNativeOttoTools: true } : {}),
    };
...
class OpenCodeAgentSession implements AgentSession {
  ...
  private resolveForegroundTurnId(params: {
    ...
    if (this.shouldStartAutonomousTurn(params.event)) {
