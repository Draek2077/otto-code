...
// runs as "general-purpose". These never become the title; the task description
// names the row instead (user-locked).
...
function normalizeObservedSubagentType(value: string | undefined | null): string | null {
 ...
 * label. Generic catch-all types ("general-purpose") are skipped in favor of
 * the description. Callers freeze the result at the first named update.
 * See docs/agent-lifecycle.md (Item 4).
 */
