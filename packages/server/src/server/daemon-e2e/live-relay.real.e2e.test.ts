...
const relayEndpoint = process.env.OTTO_LIVE_RELAY_ENDPOINT ?? "otto-relay-next.fly.dev:443";
...
async function pairingOfferFor(daemon: TestOttoDaemon): Promise<ConnectionOffer> {
