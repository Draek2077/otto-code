...
const CHILD_TOKEN = "OTTO_OMO_CHILD_READY";
const ROOT_IDLE_TOKEN = "OTTO_OMO_ROOT_WAITING";
const FINAL_TOKEN = "OTTO_OMO_AUTONOMOUS_FINAL";
const ROOT_IDLE_BARRIER = ".otto-omo-root-idle";
