import { callPluginRpc } from "@otto-code/plugin/client/host";
import type {
...
import type { PluginClientStateSource } from "@otto-code/plugin/client/host";
...
): PluginCommandCapabilities & { paseo: PluginCommandCapabilities["otto"] } {
  return {
    otto: runtime.otto,
    // The upstream alias is the same API, including in deferred action callbacks.
    paseo: runtime.otto,
