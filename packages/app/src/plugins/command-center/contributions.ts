import { callPluginRpc } from "@otto-code/plugin/host";
import type { PluginCommandCapabilities, PluginPanelLocation } from "@otto-code/plugin";
import type { PluginClientStateSource } from "@otto-code/plugin/host";
