import { parseHostPort } from "@otto-code/protocol/daemon-endpoints";
...
export type WorkspaceScriptLinkKind = "public" | "otto" | "direct";
...
export function resolveWorkspaceScriptLink(input: {
  ...
  addTarget(targets, "otto", localProxyUrl);
