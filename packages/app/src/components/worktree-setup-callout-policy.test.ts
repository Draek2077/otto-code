...
describe("shouldShowWorktreeSetupCallout", () => {
  it("shows the callout when otto config was read and setup commands are missing", () => {
  ...
  it("does not show the callout when reading otto config fails or has not completed", () => {
