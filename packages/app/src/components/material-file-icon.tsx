...
function MaterialFileIconBase({ fileName, size }: { fileName: string; size: number }) {
  return <SvgXml xml={getFileIconSvg(fileName)} width={size} height={size} />;
}

export const MaterialFileIcon = withIconSizeToken(MaterialFileIconBase, "MaterialFileIcon");
