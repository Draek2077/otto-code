...
const FIELDS = {
  ...
  messages: { id: "messages", label: "msg/s", short: "msg/s" },
  bytes: { id: "bytes", label: "B/s", short: "B/s" },
  handler: { id: "handler", label: "handler/s", short: "hnd/s" },
  ofSession: { id: "ofSession", label: "of session", short: "%ses" },
  streams: { id: "streams", label: "streams", short: "str" },
  agents: { id: "agents", label: "agents", short: "agt" },
  chats: { id: "chats", label: "chats", short: "cht" },
...
export const RESOURCE_GROUPS: ResourceGroupDef[] = [
  ...
  },
  {
    ...
    title: "Chat state",
    shortTitle: "Chat",
    fields: [FIELDS.streams, FIELDS.agents, FIELDS.chats, FIELDS.workspaces],
  },
  {
    id: "session",
    title: "Session",
