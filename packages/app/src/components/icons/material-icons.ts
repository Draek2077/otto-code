...
export const FolderPlusBold = createMaterialSymbolIcon("FolderPlusBold");
...
export const HomeBold = createMaterialSymbolIcon("HomeBold");
...
export const ServerBold = createMaterialSymbolIcon("ServerBold");
export const Settings = createMaterialSymbolIcon("Settings");
export const SettingsBold = createMaterialSymbolIcon("SettingsBold");
