...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/otto-code-ai/otto-code/releases/download";
...
export function buildMacAppleSiliconDownloadUrl(version: string | null | undefined): string | null {
  ...
  return `${RELEASE_DOWNLOAD_BASE_URL}/v${normalizedVersion}/Otto-${normalizedVersion}-arm64.dmg`;
}
