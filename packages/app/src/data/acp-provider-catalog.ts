...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "cline@3.0.40", "--acp"],
  },
  {
    id: "codebuddy-code",
    ...
    command: ["npx", "-y", "@tencent-ai/codebuddy-code@2.121.2", "--acp"],
  },
  {
    id: "codewhale",
    title: "CodeWhale",
  ...
  },
  {
    ...
    command: ["npx", "-y", "deepagents-acp@0.1.18"],
  },
  {
    id: "devin",
    title: "Devin CLI",
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.2.30", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
    ...
    command: ["npx", "-y", "dirac-cli@0.4.16", "--acp"],
  },
  {
    id: "factory-droid",
    title: "Factory Droid",
    ...
    command: ["npx", "-y", "droid@0.172.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["uvx", "--from", "fast-agent-acp==0.9.9", "fast-agent-acp", "-x"],
  },
  {
    id: "gemini",
    title: "Gemini CLI",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.0.45", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
    ...
    command: ["npx", "-y", "@qwen-code/qwen-code@0.19.10", "--acp", "--experimental-skills"],
  },
  {
    id: "sigit",
    title: "siGit Code",
