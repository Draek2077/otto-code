...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "@tencent-ai/codebuddy-code@2.150.0", "--acp"],
  },
  {
    id: "codewhale",
    title: "CodeWhale",
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.5.2", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
    ...
    command: ["npx", "-y", "dirac-cli@0.5.12", "--acp"],
  },
  {
    id: "factory-droid",
    title: "Factory Droid",
    ...
    command: ["npx", "-y", "droid@0.218.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["uvx", "--from", "fast-agent-acp==0.10.24", "fast-agent-acp", "-x"],
  },
  {
    id: "gemini",
    title: "Gemini CLI",
    ...
    command: ["npx", "-y", "@google/gemini-cli@0.59.0", "--acp"],
  },
  {
    id: "glm-acp-agent",
    title: "GLM Agent",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@minimax-ai/code@0.4.2", "acp"],
  },
  {
    id: "minion-code",
    title: "Minion Code",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@compass-ai/nova@1.1.38", "acp"],
  },
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.1.50", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
    ...
    command: ["npx", "-y", "@qwen-code/qwen-code@0.23.3", "--acp", "--experimental-skills"],
  },
  {
    id: "sigit",
    title: "siGit Code",
