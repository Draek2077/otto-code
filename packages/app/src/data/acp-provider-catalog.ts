...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "cline@3.0.50", "--acp"],
  },
  {
    id: "codebuddy-code",
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.3.3", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
  ...
  },
  {
    ...
    command: ["npx", "-y", "droid@0.188.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.1.15", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
