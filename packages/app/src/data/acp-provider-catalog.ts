...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "@tencent-ai/codebuddy-code@2.137.1", "--acp"],
  },
  {
    id: "codewhale",
    title: "CodeWhale",
  ...
  },
  {
    ...
    command: ["npx", "-y", "deepagents-acp@0.1.26"],
  },
  {
    id: "devin",
    title: "Devin CLI",
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.3.16", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
    ...
    command: ["npx", "-y", "dirac-cli@0.4.37", "--acp"],
  },
  {
    id: "factory-droid",
    title: "Factory Droid",
    ...
    command: ["npx", "-y", "droid@0.200.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["npx", "-y", "@google/gemini-cli@0.56.0", "--acp"],
  },
  {
    id: "glm-acp-agent",
    title: "GLM Agent",
    ...
    command: ["npx", "-y", "glm-acp-agent@1.6.0"],
  },
  {
    id: "goose",
    title: "goose",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.1.26", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
    ...
    command: ["npx", "-y", "@qwen-code/qwen-code@0.21.14", "--acp", "--experimental-skills"],
  },
  {
    id: "sigit",
    title: "siGit Code",
