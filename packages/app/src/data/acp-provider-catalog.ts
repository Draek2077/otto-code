...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "@tencent-ai/codebuddy-code@2.128.1", "--acp"],
  },
  {
    id: "codewhale",
    title: "CodeWhale",
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.2.39", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
    ...
    command: ["npx", "-y", "dirac-cli@0.4.28", "--acp"],
  },
  {
    id: "factory-droid",
    title: "Factory Droid",
    ...
    command: ["npx", "-y", "droid@0.182.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["uvx", "--from", "fast-agent-acp==0.9.26", "fast-agent-acp", "-x"],
  },
  {
    id: "gemini",
    title: "Gemini CLI",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.1.8", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
