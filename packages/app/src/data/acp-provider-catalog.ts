...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "cline@3.0.42", "--acp"],
  },
  {
    id: "codebuddy-code",
    ...
    command: ["npx", "-y", "@tencent-ai/codebuddy-code@2.122.0", "--acp"],
  },
  {
    id: "codewhale",
    title: "CodeWhale",
  ...
  },
  {
    ...
    command: ["npx", "-y", "droid@0.173.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["uvx", "--from", "fast-agent-acp==0.9.10", "fast-agent-acp", "-x"],
  },
  {
    id: "gemini",
    title: "Gemini CLI",
