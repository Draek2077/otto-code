...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "@tencent-ai/codebuddy-code@2.146.0", "--acp"],
  },
  {
    id: "codewhale",
    title: "CodeWhale",
  ...
  },
  {
    ...
    command: ["npx", "-y", "deepagents-acp@0.1.29"],
  },
  {
    id: "devin",
    title: "Devin CLI",
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.3.29", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
    ...
    command: ["npx", "-y", "dirac-cli@0.5.9", "--acp"],
  },
  {
    id: "factory-droid",
    title: "Factory Droid",
    ...
    command: ["npx", "-y", "droid@0.213.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["uvx", "--from", "fast-agent-acp==0.10.20", "fast-agent-acp", "-x"],
  },
  {
    id: "gemini",
    title: "Gemini CLI",
    ...
    command: ["npx", "-y", "@google/gemini-cli@0.58.0", "--acp"],
  },
  {
    id: "glm-acp-agent",
    title: "GLM Agent",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@minimax-ai/code@0.3.6", "acp"],
  },
  {
    id: "minion-code",
    title: "Minion Code",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@compass-ai/nova@1.1.37", "acp"],
  },
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.1.45", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
    ...
    command: ["npx", "-y", "@qwen-code/qwen-code@0.23.0", "--acp", "--experimental-skills"],
  },
  {
    id: "sigit",
    title: "siGit Code",
