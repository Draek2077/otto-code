...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "@tencent-ai/codebuddy-code@2.155.0", "--acp"],
  },
  {
    id: "codewhale",
    title: "CodeWhale",
  ...
  },
  {
    ...
    command: ["uvx", "--from", "fast-agent-acp==0.10.25", "fast-agent-acp", "-x"],
  },
  {
    id: "gemini",
    title: "Gemini CLI",
  ...
  },
  {
    ...
    command: ["npx", "-y", "glm-acp-agent@1.11.0"],
  },
  {
    id: "goose",
    title: "goose",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@xai-official/grok@1.0.34", "agent", "stdio"],
  },
  {
    id: "harn",
    title: "Harn",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@minimax-ai/code@0.4.12", "acp"],
  },
  {
    id: "minion-code",
    title: "Minion Code",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@compass-ai/nova@1.1.45", "acp"],
  },
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.1.58", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
    ...
    command: ["npx", "-y", "@qwen-code/qwen-code@0.24.1", "--acp", "--experimental-skills"],
  },
  {
    id: "sigit",
    title: "siGit Code",
