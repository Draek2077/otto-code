...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "@tencent-ai/codebuddy-code@2.156.0", "--acp"],
  },
  {
    id: "codewhale",
    title: "CodeWhale",
  ...
  },
  {
    ...
    command: ["npx", "-y", "deepagents-acp@0.1.32"],
  },
  {
    id: "devin",
    title: "Devin CLI",
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.5.7", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
    ...
    command: ["npx", "-y", "dirac-cli@0.5.13", "--acp"],
  },
  {
    id: "factory-droid",
    title: "Factory Droid",
    ...
    command: ["npx", "-y", "droid@0.223.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["uvx", "--from", "fast-agent-acp==0.10.27", "fast-agent-acp", "-x"],
  },
  {
    id: "gemini",
    title: "Gemini CLI",
    ...
    command: ["npx", "-y", "@google/gemini-cli@0.60.0", "--acp"],
  },
  {
    id: "gjc",
    title: "Gajae Code",
  ...
  },
  {
    ...
    command: ["npx", "-y", "glm-acp-agent@1.12.0"],
  },
  {
    id: "goose",
    title: "goose",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@xai-official/grok@1.0.40", "agent", "stdio"],
  },
  {
    id: "harn",
    title: "Harn",
    description: "Runs .harn agent pipelines as a native ACP coding agent",
    version: "0.10.139",
    iconId: "harn",
    installLink: "https://harnlang.com",
    command: ["harn", "serve", "acp"],
  },
  {
    id: "hermes",
    title: "Hermes",
  ...
  },
  {
    ...
    version: "1.1.26",
    iconId: "kimchi",
    installLink: "https://kimchi.dev",
    command: ["kimchi", "--mode", "acp"],
  },
  {
    id: "kimi",
    title: "Kimi Code CLI",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@minimax-ai/code@0.5.0", "acp"],
  },
  {
    id: "minion-code",
    title: "Minion Code",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@compass-ai/nova@1.1.46", "acp"],
  },
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.1.59", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
    ...
    command: ["npx", "-y", "@qwen-code/qwen-code@0.24.2", "--acp", "--experimental-skills"],
  },
  {
    id: "sigit",
    title: "siGit Code",
