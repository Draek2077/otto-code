...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.5.3", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
  ...
  },
  {
    ...
    command: ["npx", "-y", "droid@0.219.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["npx", "-y", "glm-acp-agent@1.9.0"],
  },
  {
    id: "goose",
    title: "goose",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@minimax-ai/code@0.4.7", "acp"],
  },
  {
    id: "minion-code",
    title: "Minion Code",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@compass-ai/nova@1.1.41", "acp"],
  },
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.1.53", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
    ...
    command: ["npx", "-y", "@qwen-code/qwen-code@0.23.4", "--acp", "--experimental-skills"],
  },
  {
    id: "sigit",
    title: "siGit Code",
