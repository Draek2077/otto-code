...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "deepagents-acp@0.1.27"],
  },
  {
    id: "devin",
    title: "Devin CLI",
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.3.18", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
  ...
  },
  {
    ...
    command: ["npx", "-y", "droid@0.202.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.1.28", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
