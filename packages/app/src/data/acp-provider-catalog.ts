...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.3.5", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
  ...
  },
  {
    ...
    command: ["npx", "-y", "droid@0.189.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["npx", "-y", "@google/gemini-cli@0.54.0", "--acp"],
  },
  {
    id: "glm-acp-agent",
    title: "GLM Agent",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.1.16", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
