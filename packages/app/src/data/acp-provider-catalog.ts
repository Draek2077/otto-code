...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "@tencent-ai/codebuddy-code@2.154.0", "--acp"],
  },
  {
    id: "codewhale",
    title: "CodeWhale",
  ...
  },
  {
    ...
    command: ["npx", "-y", "droid@0.222.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["npx", "-y", "@compass-ai/nova@1.1.44", "acp"],
  },
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.1.56", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
    ...
    command: ["npx", "-y", "@qwen-code/qwen-code@0.24.0", "--acp", "--experimental-skills"],
  },
  {
    id: "sigit",
    title: "siGit Code",
