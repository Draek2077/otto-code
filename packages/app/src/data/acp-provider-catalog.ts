...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "@augmentcode/auggie@0.34.0", "--acp"],
    env: {
  ...
  },
  {
    ...
    command: ["npx", "-y", "cline@3.0.48", "--acp"],
  },
  {
    id: "codebuddy-code",
    ...
    command: ["npx", "-y", "@tencent-ai/codebuddy-code@2.131.0", "--acp"],
  },
  {
    id: "codewhale",
    title: "CodeWhale",
  ...
  },
  {
    ...
    command: ["npx", "-y", "deepagents-acp@0.1.22"],
  },
  {
    id: "devin",
    title: "Devin CLI",
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.3.1", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
    ...
    command: ["npx", "-y", "dirac-cli@0.4.31", "--acp"],
  },
  {
    id: "factory-droid",
    title: "Factory Droid",
    ...
    command: ["npx", "-y", "droid@0.185.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["uvx", "--from", "fast-agent-acp==0.9.28", "fast-agent-acp", "-x"],
  },
  {
    id: "gemini",
    title: "Gemini CLI",
    ...
    command: ["npx", "-y", "@google/gemini-cli@0.53.0", "--acp"],
  },
  {
    id: "glm-acp-agent",
    title: "GLM Agent",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@compass-ai/nova@1.1.30", "acp"],
  },
  {
    id: "otto-brain",
    title: "Otto Brain",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.1.10", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
    ...
    command: ["npx", "-y", "@qwen-code/qwen-code@0.21.2", "--acp", "--experimental-skills"],
  },
  {
    id: "sigit",
    title: "siGit Code",
