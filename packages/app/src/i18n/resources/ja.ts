...
export const ja: TranslationResources = {
  ...
  workspace: {
    moveChat: {
      title: "チャットをワークスペースに移動",
      move: "移動",
      moving: "移動中…",
      empty: "このホストには、このチャットを移動できる他のワークスペースがありません。",
      moved: "{{workspace}} に移動しました",
      errors: {
        failed: "チャットを移動できませんでした",
      },
    },
    route: {
    ...
    tabs: {
      ...
      menu: {
        ...
        copyWorkspacePath: "ワークスペースパスをコピー",
        rename: "名前を変更",
    ...
    git: {
      ...
      commit: {
        type: {
          selectorLabel: "コミットの種類",
          none: "なし",
          noneDescription: "プレフィックスなし",
          featDescription: "新しい機能",
          fixDescription: "バグ修正",
          docsDescription: "ドキュメントのみ",
          styleDescription: "フォーマットのみ（コード変更なし）",
          refactorDescription: "リファクタリング（挙動変更なし）",
          perfDescription: "パフォーマンス改善",
          testDescription: "テストのみ",
          buildDescription: "ビルドシステムまたは依存関係",
          ciDescription: "CI 設定",
          choreDescription: "その他・メンテナンス",
          revertDescription: "以前のコミットを取り消す",
        },
  ...
  pairing: {
    ...
    device: {
      ...
      relayDocs: "リレーの仕組み",
      relayDocsAccessibility: "Otto リレーの仕組みを読む",
      enableRelay: "リレーを有効にする",
      enablingRelay: "有効化中...",
      notNow: "今はしない",
      directConnectionHint:
        "リレーを使わない場合は、TCP、Tailscale、または別の VPN で直接接続してください。QR コードは作成されません。",
      updateRequired: "Otto Desktop からリレーを有効にするにはホストを更新してください。",
    ...
    remoteSsh: {
      title: "リモート SSH",
      helper: "リモートホストで動作する Otto デーモンに接続します。",
      fields: {
        target: "SSH ホスト",
      },
      actions: {
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "Ottoを{{count}}回呼び出し",
      other: "Ottoを{{count}}回呼び出し",
    },
  },
  renameModal: {
    rename: "名前を変更",
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Otto が通知をオペレーティングシステムに渡しました。",
    ...
    metadataGeneration: {
      ...
      automatic: "自動",
      preferred: "手動",
      automaticHint: "Otto が利用可能な高速モデルを選択します",
      preferredHint: "Otto が使用するモデルを選択します",
      model: "モデル",
      fallbackHint: "利用できない場合、Otto は別の利用可能なモデルを使用します",
      docs: "ドキュメント",
    ...
    appearance: {
      ...
      agents: {
        ...
        wrapToolCallText: {
          ...
          accessibilityLabel: "ツール呼び出しテキストを折り返す",
        },
        chatMetricsBar: {
          title: "チャットのメトリクスを表示",
          hint: "このチャットの合計トークン数、コスト、サブエージェントの動きを示す、トランスクリプト上部の細い行です。",
      ...
      sidebar: {
        ...
        moveUp: "上に移動",
        moveDown: "下に移動",
        workspaceActions: "ワークスペース見出しの操作",
      },
    },
    shortcuts: {
      dialogTitle: "ショートカット",
    ...
    host: {
      ...
      gitProviders: {
        ...
        github: {
          ...
          usedFor: "プルリクエストとカンバンボード（GitHub Projects）",
          scopesTitle: "必要なスコープ",
          scopesHint:
            "Projects のボードには read:project と project が必要です。プライベートリポジトリのカードを読むには repo も必要です。付与するには: gh auth refresh -s read:project,project",
        },
        atlassian: {
          name: "Atlassian",
          hint: "Jira と Bitbucket Cloud で共通のアカウント",
          usedFor: "カンバンボード（Jira）とプルリクエスト（Bitbucket Cloud）",
          email: "Atlassian メールアドレス",
          apiToken: "API トークン",
          apiTokenHint: "ホスト上に非公開で保存され、リポジトリには保存されません",
          apiTokenPlaceholder: "API トークンを貼り付け",
          jiraSiteUrl: "Jira サイト",
          jiraSiteUrlHint:
            "Jira のボードにのみ必要です。サイト名または完全な URL を入力してください。",
          jiraSiteUrlPlaceholder: "acme.atlassian.net",
          scopesTitle: "必要なスコープ",
          scopesHint:
            "スコープ付きトークンには read:jira-work、write:jira-work、read:board-scope:jira-software、read:project:jira が必要です。スコープなしのトークンでも動作しますが、権限は広くなります。",
      ...
      code: {
        ...
        enabledHint:
          "プロジェクトごとに言語サーバーを起動し、定義へ移動がカーソル位置のシンボルを解決します。オフにすると名前ベースのインデックスに戻ります。",
        solution: "Microsoft .NET ソリューション管理",
        solutionHint:
          "ファイルタブに Solution ビューを追加し、.sln や .slnx をビルドシステムから見たとおりに表示します。このホストに .NET SDK が必要です。",
        csharpScope: "C# プロジェクトの読み込み",
        csharpScopeHint:
          "C# 言語サーバーが .NET ワークスペースをどこまで読み込むか。Solution はルートの単一ソリューションファイルを読むため大幅に高速で、All projects は取りこぼしがない代わりに大規模リポジトリでは数分かかることがあります。",
        ...
        install: {
          ...
          runMessage:
            "ホストで新しいターミナルを開き、表示されたコマンドを正確に実行して、そのターミナルに移動します：\n\n{{command}}",
          runConfirm: "実行",
          runCancel: "キャンセル",
          terminalTitle: "{{id}} をインストール",
          terminalStarted: "ターミナルを開始しました",
          terminalFailed: "このホストでターミナルを開けませんでした",
        },
      },
      storage: {
        title: "エージェントが生成した画像",
        ...
        hostImagesHint:
          "エージェントが生成したスクリーンショットなどの画像で、過去のメッセージが表示できるよう保持されます。消去は取り消せません。",
        previewCache: "この端末上のキャッシュ",
        previewCacheSummary: "{{count}} 件の画像で {{size}}",
        previewCacheEmpty: "キャッシュはありません",
        previewCacheHint:
          "画像を即座に表示するためのローカルコピーで、必要になれば再ダウンロードされるため安全に消せます。メッセージに添付したファイル（{{size}}）は別に保存されます。",
        clear: "消去",
        clearConfirm: "画像を消去",
        ...
        maxAge: "画像を保持する期間",
        maxAgeHint: "使われていない画像を自動削除するまで保持する日数。0 で無効になります。",
        maxTotal: "最大サイズ",
        maxTotalHint:
          "このホストで保持する画像の容量（MB）。古いものから削除され、0 で無効になります。",
      },
      workspaces: {
    ...
    providers: {
      ...
      agents: {
        ...
        maxToolRoundsHint:
          "ターンが終わるまでにモデルがツールを呼び出して結果を読める回数。個々のツール呼び出しではなくラウンド数を数えます。",
        ...
        midSessionUpdatesHint:
          "エージェントがサブフォルダーで初めて作業するとき、そのフォルダーの AGENTS.md を読み込ませます。オフにすると、会話はあなたとモデルが入れたものだけになります。",
      ...
      models: {
        ...
        removeModel: "{{id}}を削除",
        visibilityLabel: "モデル選択に {{id}} を表示",
        visibleCount: "{{total}}件中{{visible}}件を表示",
        showAll: "すべて表示",
        hideAll: "すべて非表示",
        searchPlaceholder: "モデルを検索",
        loading: "モデルを読み込み中...",
    ...
    project: {
      ...
      kanban: {
        sectionTitle: "Kanban",
        description: "このプロジェクトが Kanban 画面で表示するトラッキングボードです。",
        adapter: "ボードの提供元",
        adapterNone: "なし",
        ...
        githubBoard: "ボード",
        githubBoardHint:
          "空にすると、このプロジェクトの GitHub リポジトリのボードを使用します。それ以外の場合は、プロジェクトのボード番号または URL を貼り付けてください。",
        githubBoardPlaceholder: "ボード番号または URL",
        jiraBoard: "ボード",
        jiraBoardHint: "Jira のボード ID、またはボードの URL。Jira の場合は必須です。",
        jiraBoardPlaceholder: "ボード ID または URL",
        credentialsHint: "両方のプロバイダーのサインインは、設定でホストごとに 1 回設定されます。",
        saveError: "Kanban ボードのターゲットを保存できませんでした。",
        jiraBoardRequired: "Jira のボード ID を入力してください。",
      },
      knowledge: {
      ...
      worktree: {
        ...
        uncommittedTitle: "otto.json の変更をコミットしてください",
    ...
    layout: {
      openInSidePane: {
        ...
        sources: {
          ...
          diffs: {
            label: "差分を開く",
            description: "エクスプローラーやエージェントの会話の差分を作業の横に開きます",
          },
        },
      },
    },
  ...
  kanban: {
    ...
    board: "ボード",
    refresh: "ボードを再取得",
    noHostsTitle: "利用可能なボードがありません",
    noHostsBody: "Kanban 機能を持つホストを接続すると、そのボードを表示できます。",
    noProjectsTitle: "このホストにプロジェクトがありません",
    noProjectsBody: "このホストでプロジェクトを開くと、ボードで追跡できます。",
    unconfiguredTitle: "ボードが設定されていません",
    unconfiguredBody:
      "このプロジェクトに表示するには、GitHub または Jira のボードを選択してください。",
    unconfiguredAction: "プロジェクト設定を開く",
    boardError: "ボードを読み込めませんでした",
    remediation: {
      copy: "コマンドをコピー",
      copied: "コマンド",
      copyFailed: "コマンドをコピーできませんでした",
      run: "ターミナルで実行",
      runTitle: "このコマンドを実行しますか？",
      runMessage:
        "Otto はこのプロジェクトでターミナルを開き、次を実行します:\n\n{{command}}\n\nそのターミナルに移動してサインインを完了してください。ワンタイムコードが表示され、ブラウザーが開きます。",
      runConfirm: "実行",
      runCancel: "キャンセル",
      terminalTitle: "GitHub サインイン",
      terminalStarted: "サインインを完了するためのターミナルを開きました",
      terminalFailed: "このホストでターミナルを開けませんでした",
      hint: "ターミナルでサインインを完了し、戻ってボードを再取得してください。",
    },
    addCard: "カードを追加",
