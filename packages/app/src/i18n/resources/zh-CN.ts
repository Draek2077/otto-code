...
export const zhCN: TranslationResources = {
    ...
    git: {
      ...
      commit: {
        type: {
          selectorLabel: "提交类型",
          none: "无",
          noneDescription: "不添加类型前缀",
          featDescription: "新功能",
          fixDescription: "修复缺陷",
          docsDescription: "仅文档",
          styleDescription: "仅格式，无代码变更",
          refactorDescription: "重构，无行为变更",
          perfDescription: "性能优化",
          testDescription: "仅测试",
          buildDescription: "构建系统或依赖",
          ciDescription: "CI 配置",
          choreDescription: "杂务与维护",
          revertDescription: "还原之前的提交",
        },
  ...
  settings: {
    ...
    shortcuts: {
      ...
      help: {
        ...
        markdownLink: "插入链接",
        markdownBulletList: "项目符号列表",
        markdownOrderedList: "编号列表",
        markdownTaskList: "任务列表",
        markdownToggleTask: "勾选/取消勾选任务",
    ...
    host: {
      ...
      gitProviders: {
        ...
        github: {
          ...
          usedFor: "拉取请求和看板（GitHub Projects）",
          scopesTitle: "所需权限范围",
          scopesHint:
            "Projects 看板需要 read:project 和 project 权限；读取私有仓库中的卡片还需要 repo 权限。授予方式：gh auth refresh -s read:project,project",
        },
        atlassian: {
          name: "Atlassian",
          hint: "Jira 与 Bitbucket Cloud 共用一个账号",
          usedFor: "看板（Jira）和拉取请求（Bitbucket Cloud）",
          email: "Atlassian 邮箱",
          apiToken: "API 令牌",
          apiTokenHint: "私密保存在 Host 上，绝不会存入仓库",
          apiTokenPlaceholder: "粘贴 API 令牌",
          jiraSiteUrl: "Jira 站点",
          jiraSiteUrlHint: "仅 Jira 看板需要。填写站点名称或完整 URL。",
          jiraSiteUrlPlaceholder: "acme.atlassian.net",
          scopesTitle: "所需权限范围",
          scopesHint:
            "限定范围的令牌需要 read:jira-work、write:jira-work、read:board-scope:jira-software 和 read:project:jira。不限范围的令牌也可使用，但权限更宽。",
          saveError: "保存凭据失败",
          readyToCheck: "凭据已保存",
      ...
      code: {
        ...
        install: {
          ...
          runTitle: "在终端中运行安装命令？",
          runMessage:
            "这将在主机上打开一个新终端，运行显示的准确命令，并带你进入该终端：\n\n{{command}}",
          runConfirm: "运行",
          runCancel: "取消",
          terminalTitle: "安装 {{id}}",
          terminalStarted: "终端已启动",
          terminalFailed: "无法在此主机上打开终端",
        },
      },
      storage: {
        title: "来自 Agent 的图片",
    ...
    providers: {
      ...
      models: {
        ...
        removeModel: "移除 {{id}}",
        visibilityLabel: "在模型选择器中显示 {{id}}",
        visibleCount: "显示 {{visible}}/{{total}} 个",
        showAll: "全部显示",
        hideAll: "全部隐藏",
    ...
    project: {
      ...
      kanban: {
        sectionTitle: "Kanban",
        description: "此项目在 Kanban 屏幕上显示的跟踪看板。",
        adapter: "看板提供方",
        adapterNone: "无",
        adapterGithub: "GitHub Projects",
        adapterJira: "Jira",
        githubBoard: "看板",
        githubBoardHint: "留空以使用此项目 GitHub 仓库中的看板。否则，粘贴一个看板编号或 URL。",
        githubBoardPlaceholder: "看板编号或 URL",
        jiraBoard: "看板",
        jiraBoardHint: "Jira 看板 ID，或看板 URL。Jira 必填。",
        jiraBoardPlaceholder: "看板 ID 或 URL",
        credentialsHint: "两个提供方的登录在设置中按主机配置一次。",
        saveError: "无法保存 Kanban 看板目标。",
        jiraBoardRequired: "请输入 Jira 看板 ID。",
      },
      knowledge: {
  ...
  kanban: {
    ...
    board: "看板",
    refresh: "刷新看板",
    noHostsTitle: "没有可用的看板",
    noHostsBody: "连接一个具备 Kanban 功能的主机以查看其看板。",
    noProjectsTitle: "此主机上没有项目",
    noProjectsBody: "在此主机上打开一个项目即可在看板上跟踪它。",
    unconfiguredTitle: "未配置看板",
    unconfiguredBody: "为此项目选择一个 GitHub 或 Jira 看板，即可在此查看。",
    unconfiguredAction: "打开项目设置",
    boardError: "无法加载看板",
    remediation: {
      copy: "复制命令",
      copied: "命令",
      ...
      runTitle: "运行此命令？",
      runMessage:
        "Otto 会在此项目中打开终端并运行：\n\n{{command}}\n\n随后会带你进入该终端完成登录：它会显示一次性代码并打开浏览器。",
      runConfirm: "运行",
      runCancel: "取消",
      terminalTitle: "GitHub 登录",
      terminalStarted: "已打开终端以完成登录",
      terminalFailed: "无法在此主机上打开终端",
      hint: "在终端中完成登录，然后返回并重新加载看板。",
    },
    addCard: "添加卡片",
