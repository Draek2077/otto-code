  ...
  settings: {
    ...
    providers: {
      ...
      agents: {
        ...
        maxToolRoundsLabel: "Максимум раундов инструментов за ход",
        maxToolRoundsHint:
          "Ход завершается ошибкой после указанного числа раундов инструментов без итогового ответа - предохранитель от бесконечных циклов.",
        maxToolRoundsValue: "Раундов: {{rounds}}",
        maxToolRoundsRequiresUpdate:
          "Обновите хост, чтобы настроить максимум раундов инструментов.",
