export const en = {
  ...
  shell: {
    ...
    commandCenter: {
      placeholder: "Search commands, files, workspaces, and chats...",
      chatMessages: "Chat messages",
      you: "You",
      assistant: "Assistant",
      archived: "Archived",
      indexingChats: "{{count}} chats are being indexed",
      historyUnavailable: "Some chat history is unavailable; retrying automatically",
      updateHostForChats: "Update the host to search chat messages",
      moreChatMatches: "More matches available. Refine your search.",
      messageChanged: "This message changed. Search again to see the current results.",
    ...
    git: {
      ...
      actions: {
        ...
        pull: {
          ...
          pending: "Pulling...",
          success: "Pulled",
          description: "Bring remote commits into this branch",
        },
        push: {
          label: "Push",
          pending: "Pushing...",
          success: "Pushed",
          description: "Send local commits to the remote",
        },
        pullAndPush: {
          label: "Pull and push",
          pending: "Pulling and pushing...",
          success: "Pulled and pushed",
          description: "Bring in remote commits, then send yours",
        },
        fetch: {
          label: "Fetch",
          pending: "Fetching...",
          success: "Fetched",
          description: "Update remote branches and prune deleted ones",
        },
        viewPr: "View PR",
  ...
  settings: {
    ...
    plugins: {
      ...
      idHint: "Leave blank to use otto-plugin.json",
    ...
    providers: {
      ...
      models: {
        ...
        visibilityLabel: "Show {{id}} in model pickers",
