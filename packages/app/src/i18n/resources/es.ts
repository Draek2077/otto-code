...
export const es: TranslationResources = {
  ...
  contextManagement: {
    ...
    memory: {
      noPersonality:
        "Elige arriba un perfil para ver lo que ha aprendido y lo que eso añade a cada petición que hace.",
      loading: "Leyendo lo que recuerda este perfil…",
      failed: "No se pudo leer la memoria de este perfil: {{error}}",
      emptyNamed:
      ...
      brief: {
        ...
        disabled:
          "La memoria está desactivada para este perfil, así que no se envía nada de esto. Las lecciones se conservan.",
        empty: "No se añade nada al contexto de este perfil en este proyecto.",
        emptyButStored_one:
      ...
      forgetDialog: {
        ...
        message: "«{{lesson}}» se eliminará de la memoria de este perfil.",
        confirm: "Olvidar",
      },
      composer: {
        placeholder: "¿Qué debería recordar este perfil?",
      ...
      transfer: {
        ...
        noCandidates:
          "No hay otro perfil al que pasarle estas lecciones. Al eliminar {{name}} se descartarán.",
        sameRole: "mismo rol",
      },
    },
    findings: {
  ...
  message: {
    ...
    actions: {
      ...
      navigateToFolder: "Ir a la carpeta",
      copied: "Copiado",
    },
    expandCollapse: {
    ...
    attachments: {
      ...
      saveImageFailed: "No se pudo guardar la imagen",
  ...
  workspace: {
    ...
    hoverCard: {
      ...
      copied: "Copiado",
      branchHistory_one: "{{count}} commit por delante de {{baseRef}}",
      branchHistory_other: "{{count}} commits por delante de {{baseRef}}",
    },
    ...
    tabs: {
      ...
      menu: {
        ...
        copyWorkspacePath: "Copiar ruta del espacio de trabajo",
        rename: "Rebautizar",
      ...
      toasts: {
        ...
        filenameCopiedLabel: "Nombre de archivo",
        workspacePathCopiedLabel: "Ruta del espacio de trabajo",
    ...
    git: {
      ...
      commit: {
        type: {
          selectorLabel: "Tipo de commit",
          none: "Ninguno",
          noneDescription: "Sin prefijo de tipo",
          featDescription: "Nueva funcionalidad",
          fixDescription: "Corrección de error",
          docsDescription: "Solo documentación",
          styleDescription: "Formateo, sin cambio de código",
          refactorDescription: "Refactorización, sin cambio de comportamiento",
          perfDescription: "Mejora de rendimiento",
          testDescription: "Solo pruebas",
          buildDescription: "Sistema de build o dependencias",
          ciDescription: "Configuración de CI",
          choreDescription: "Tareas de mantenimiento",
          revertDescription: "Reviente un commit anterior",
        },
      ...
      commitAgent: {
        ...
        messagePersonality: "El perfil {{name}} ({{detail}}) escribirá tu mensaje de commit.",
        messageProvider: "{{detail}} escribirá tu mensaje de commit.",
        noneTitle: "No hay ningún agente de IA disponible",
        noneMessage:
          "No hay ningún agente de IA ni modelo configurado para escribir un mensaje de commit. Configura un proveedor o un Perfil de agente y vuelve a intentarlo.",
        noneConfirm: "Aceptar",
      },
      rollback: {
  ...
  desktop: {
    ...
    window: {
      ...
      trayIcon: {
        ...
        hint: "Mantiene un icono de Otto en la bandeja del sistema mientras se ejecuta la aplicación",
      },
      minimizeToTray: {
  ...
  pairing: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leer cómo funciona el relé de Otto",
      ...
      updateRequired: "Actualice el host para habilitar el relé desde Otto Desktop.",
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conéctate a un daemon de Otto en el host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
  ...
  projectSearch: {
    ...
    collapseAll: "Contraer todos los archivos",
    expandAll: "Expandir todos los archivos",
    refresh: "Volver a ejecutar la búsqueda",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "llamó a Otto {{count}} vez",
      other: "llamó a Otto {{count}} veces",
    },
  },
  renameModal: {
    rename: "Rebautizar",
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Otto entregó la notificación al sistema operativo.",
    ...
    metadataGeneration: {
      ...
      description:
        "Elige el modelo que Otto usa para títulos de espacios de trabajo, nombres de ramas, mensajes de commit y borradores de pull requests",
      selection: "Selección de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "Otto elige un modelo rápido disponible",
      preferredHint: "Elige el modelo que usa Otto",
      model: "Modelo",
      fallbackHint: "Si no está disponible, Otto usa otro modelo disponible",
      docs: "Documentación",
    ...
    general: {
      ...
      mountedWorkspaceLimit: {
        ...
        description:
          "Cuántos workspaces siguen cargados para cambiar al instante. Ponlo al menos en la cantidad entre la que alternas. Más consume más memoria.",
        accessibilityLabel: "Workspaces que siguen cargados",
      },
      mountedTabLimit: {
        label: "Pestañas que siguen cargadas",
        description:
          "Cuántas pestañas por panel siguen cargadas para cambiar al instante. Déjalo vacío para seguir a este dispositivo ({{auto}}). Más consume más memoria.",
    ...
    appearance: {
      ...
      sidebar: {
        ...
        workspaceActions: "Acciones de la cabecera de espacios de trabajo",
      },
    },
    shortcuts: {
      dialogTitle: "Atajos",
    ...
    host: {
      ...
      code: {
        ...
        install: {
          ...
          runMessage:
            "Esto abre una nueva terminal en el host, ejecuta el comando exacto mostrado y te lleva a ella:\n\n{{command}}",
          runConfirm: "Ejecutar",
          runCancel: "Cancelar",
          terminalTitle: "Instalar {{id}}",
          terminalStarted: "Terminal iniciada",
          terminalFailed: "No se pudo abrir una terminal en este host",
        },
      },
      storage: {
    ...
    providers: {
      ...
      models: {
        ...
        visibilityLabel: "Mostrar {{id}} en los selectores de modelos",
        visibleCount: "{{visible}} de {{total}} visibles",
    ...
    project: {
      ...
      worktree: {
        ...
        uncommittedTitle: "Confirma los cambios de otto.json",
    ...
    layout: {
      openInSidePane: {
        ...
        sources: {
          ...
          diffs: {
            label: "Abrir una diferencia",
            description:
              "Abre diferencias del Explorador y conversaciones de agentes junto a tu trabajo",
          },
        },
      },
    },
  ...
  kanban: {
    ...
    noHostsTitle: "No hay tableros disponibles",
    noHostsBody: "Conecta un host con la función Kanban para ver sus tableros.",
    noProjectsTitle: "No hay proyectos en este host",
    noProjectsBody: "Abre un proyecto en este host para seguirlo en un tablero.",
    unconfiguredTitle: "No hay tablero configurado",
    unconfiguredBody: "Elige un tablero de GitHub o Jira para este proyecto para verlo aquí.",
    unconfiguredAction: "Abrir la configuración del proyecto",
    boardError: "No se pudieron cargar los tableros",
    remediation: {
      copy: "Copiar comando",
      copied: "comando",
      copyFailed: "No se pudo copiar el comando",
      run: "Ejecutar en la terminal",
      runTitle: "¿Ejecutar este comando?",
      runMessage:
        "Otto abre una terminal en este proyecto y ejecuta:\n\n{{command}}\n\nTe llevará a esa terminal para terminar el inicio de sesión: muestra un código de un solo uso y abre tu navegador.",
      runConfirm: "Ejecutar",
      runCancel: "Cancelar",
      terminalTitle: "Inicio de sesión de GitHub",
      terminalStarted: "Se abrió una terminal para terminar el inicio de sesión",
      terminalFailed: "No se pudo abrir una terminal en este host",
      hint: "Termina el inicio de sesión en la terminal, vuelve y recarga los tableros.",
    },
