...
export const ko: TranslationResources = {
  ...
  pairing: {
    ...
    remoteSsh: {
      title: "원격 SSH",
      helper: "원격 호스트에서 실행 중인 Otto 데몬에 연결합니다.",
      fields: {
        target: "SSH 호스트",
      },
      actions: {
  ...
  settings: {
    ...
    providers: {
      ...
      models: {
        ...
        removeModel: "{{id}} 제거",
        visibilityLabel: "모델 선택기에 {{id}} 표시",
        visibleCount: "{{total}}개 중 {{visible}}개 표시",
        showAll: "모두 표시",
        hideAll: "모두 숨기기",
        searchPlaceholder: "모델 검색",
        loading: "모델 불러오는 중...",
    ...
    layout: {
      openInSidePane: {
        ...
        sources: {
          ...
          diffs: {
            label: "차이 열기",
            description: "탐색기와 에이전트 대화의 차이를 작업 옆에 엽니다",
          },
        },
      },
    },
