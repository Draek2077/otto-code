...
export const ar: TranslationResources = {
  ...
  editor: {
    ...
    reloadDialog: {
      title: "إعادة التحميل من القرص؟",
      message: "هل تريد تجاهل تعديلاتك غير المحفوظة وتحميل نسخة هذا الملف الموجودة على القرص الآن؟",
  ...
  settings: {
    ...
    providers: {
      ...
      tools: {
        policy: {
          save: "حفظ",
          enabled: "تفعيل أدوات Otto",
          description:
            "يتحكم في أدوات Otto عند بدء المحادثة أو استئنافها. لا تتغير أدوات المزوّد نفسه وأذونات الموصلات المستقلة.",
          disabledTools: "الأدوات المعطّلة",
          namesHint:
            "اسم أداة دقيق واحد في كل سطر، مثل create_agent. القائمة الفارغة لا تحظر شيئًا. الحظر بالاسم ينطبق أيضًا على أدوات الموصلات.",
          updateHost: "حدّث المضيف لإعداد أدوات Otto لكل مزوّد.",
          unavailable: "اتصل بهذا المضيف ثم أعد محاولة الحفظ.",
        },
        title: "أدوات Otto",
        description:
