  ...
  settings: {
    ...
    host: {
      ...
      code: {
        ...
        csharpScopeHint:
          "مقدار ما يحمّله خادم لغة ‎C#‎ من مساحة عمل ‎.NET‎. يستخدم خيار الحل ملف الحل الوحيد في جذر مساحة العمل، وهو يُحمَّل كوحدة واحدة وأسرع بكثير. أما كل المشاريع فيحمّل كل ملف ‎.csproj‎ ضمن الجذر، فلا يفوته شيء، لكنها تُحمَّل واحدًا تلو الآخر وقد يستغرق المستودع الكبير دقائق قبل أن يستجيب التمرير والانتقال إلى التعريف.",
    ...
    providers: {
      ...
      agents: {
        ...
        midSessionUpdatesHint:
          "اسمح للوكيل بتحميل ملف AGENTS.md الخاص بمجلد فرعي عند أول عمل له فيه. أوقف هذا الخيار لإبقاء المحادثة مقتصرة على ما تضعه أنت والنموذج فيها، وهو ما يهم أكثر مع نافذة سياق محلية صغيرة.",
