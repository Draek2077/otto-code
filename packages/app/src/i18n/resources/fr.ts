...
export const fr: TranslationResources = {
  common: {
    ...
    linkTooltip: {
      modClickOpenInPlace: "cliquer pour ouvrir sur place",
      clickToOpen: "Cliquer pour ouvrir",
      findingFile: "Recherche de ce fichier dans l’espace de travail…",
      fileNotFound: "Aucun fichier correspondant dans cet espace de travail",
      cannotOpen: "Otto ne peut pas ouvrir ce lien",
    },
    back: "Retour",
    loading: "Chargement...",
    actions: {
  ...
  composer: {
    ...
    attachments: {
      ...
      queuedAttachments_one: "{{count}} pièce jointe",
      queuedAttachments_other: "{{count}} pièces jointes",
  ...
  message: {
    ...
    actions: {
      ...
      navigateToFolder: "Aller au dossier",
      copied: "Copié",
    },
    expandCollapse: {
    ...
    selectionActions: {
      ...
      explain: {
        label: "Expliquer",
        description: "Le décomposer pour le rendre facile à suivre.",
        prompt:
          "Explique ceci plus en détail. Explique-moi ce que cela signifie et pourquoi c'est important.",
      },
      contest: {
        label: "Contester",
        description: "Le remettre en question et vérifier qu'il tient.",
        prompt:
          "Je veux remettre ceci en question. Vérifie si c'est vraiment correct, signale les failles ou les hypothèses implicites, et corrige-le si c'est faux.",
      },
      research: {
        label: "Rechercher",
        description: "Creuser davantage et l'étayer par des preuves.",
        prompt:
          "Approfondis ce point. Examine-le en détail, en t'appuyant sur le code et toutes les sources accessibles, puis rends compte des preuves trouvées.",
      },
      complete: {
        label: "Compléter",
        description: "Le mener à terme et combler ce qui manque.",
        prompt:
          "Mène ceci à terme. Fais ce qui est décrit et complète tout ce qui a été laissé inachevé.",
      },
    },
    attachments: {
      ...
      copyImageFailed: "Impossible de copier l’image",
      saveImageFailed: "Impossible d’enregistrer l’image",
  ...
  workspace: {
    ...
    tabs: {
      ...
      menu: {
        ...
        copyWorkspacePath: "Copier le chemin de l'espace de travail",
        rename: "Rebaptiser",
      ...
      toasts: {
        ...
        filenameCopiedLabel: "Nom du fichier",
    ...
    git: {
      ...
      commit: {
        type: {
          selectorLabel: "Type de commit",
          none: "Aucun",
          noneDescription: "Sans préfixe de type",
          featDescription: "Nouvelle fonctionnalité",
          fixDescription: "Correction de bug",
          docsDescription: "Documentation uniquement",
          styleDescription: "Mise en forme, aucun changement de code",
          refactorDescription: "Refactorisation, aucun changement de comportement",
          perfDescription: "Amélioration des performances",
          testDescription: "Tests uniquement",
          buildDescription: "Système de build ou dépendances",
          ciDescription: "Configuration CI",
          choreDescription: "Tâches et maintenance",
          revertDescription: "Annule un commit précédent",
        },
  ...
  newWorkspace: {
    ...
    createDocumentation: "Créer la documentation",
    startEmptyWorkspace: "Démarrer un espace de travail vide",
    isolation: {
      local: "Local",
  ...
  pairing: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Lire comment fonctionne le relais Otto",
      ...
      updateRequired: "Mettez à jour l’hôte pour activer le relais depuis Otto Desktop.",
    ...
    remoteSsh: {
      title: "SSH distant",
      helper: "Connectez-vous à un daemon Otto sur l’hôte distant.",
      fields: {
        target: "Hôte SSH",
      },
      actions: {
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "a appelé Otto {{count}} fois",
      other: "a appelé Otto {{count}} fois",
    },
  },
  renameModal: {
    rename: "Rebaptiser",
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Otto a transmis la notification au système d’exploitation.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choisissez le modèle utilisé par Otto pour les titres d’espaces de travail, les noms de branches, les messages de commit et les brouillons de pull request",
      selection: "Sélection du modèle",
      automatic: "Automatique",
      preferred: "Manuel",
      automaticHint: "Otto choisit un modèle rapide disponible",
      preferredHint: "Choisissez le modèle utilisé par Otto",
      model: "Modèle",
      fallbackHint: "S’il est indisponible, Otto utilise un autre modèle disponible",
      docs: "Documentation",
    ...
    appearance: {
      ...
      agents: {
        ...
        chatMetricsBar: {
          ...
          hint: "Une fine ligne au-dessus de la transcription avec le total de tokens, le coût et l'activité des sous-agents de ce chat.",
      ...
      sidebar: {
        ...
        workspaceActions: "Actions de l’en-tête des espaces de travail",
      },
    },
    shortcuts: {
    ...
    host: {
      ...
      code: {
        ...
        enabledHint:
          "Lance un serveur de langage par projet pour que Aller à la définition résolve le symbole sous le curseur. Désactivé, revient à l'index basé sur les noms.",
        solution: "Gestion des solutions Microsoft .NET",
        solutionHint:
          "Ajoute une vue Solution à l'onglet Fichiers, montrant votre .sln ou .slnx tel que le système de build le voit. Nécessite le SDK .NET sur cet hôte.",
        csharpScope: "Chargement des projets C#",
        csharpScopeHint:
          "Quelle part d'un workspace .NET le serveur C# charge. Solution lit l'unique fichier solution de la racine et est bien plus rapide ; Tous les projets n'omet rien mais peut prendre des minutes sur un grand dépôt.",
        csharpScopeSolution: "Solution",
        csharpScopeAllProjects: "Tous les projets",
        languages: "Langages",
        ...
        install: {
          ...
          runMessage:
            "Ceci ouvre un nouveau terminal sur l'hôte, exécute la commande exacte affichée et vous y conduit :\n\n{{command}}",
          runConfirm: "Exécuter",
          runCancel: "Annuler",
          terminalTitle: "Installer {{id}}",
          terminalStarted: "Terminal démarrée",
          terminalFailed: "Impossible d'ouvrir un terminal sur cet hôte",
        },
      },
      storage: {
        ...
        hostImagesHint:
          "Captures et autres images produites par vos agents, conservées pour que les anciens messages puissent encore les afficher. La suppression est irréversible.",
        previewCache: "Copies en cache sur cet appareil",
        previewCacheSummary: "{{size}} sur {{count}} images",
        previewCacheEmpty: "Rien en cache",
        previewCacheHint:
          "Copies locales pour un chargement instantané des images ; sans risque à effacer, elles se retéléchargent. Les fichiers joints à vos messages ({{size}}) sont conservés séparément.",
        clear: "Effacer",
        ...
        maxAgeHint:
          "Jours de conservation d'une image inutilisée avant sa suppression automatique. 0 désactive.",
        maxTotal: "Taille maximale",
        maxTotalHint:
          "Mégaoctets d'images à conserver sur cet hôte, les plus anciennes étant supprimées d'abord. 0 désactive.",
      },
      workspaces: {
    ...
    providers: {
      ...
      agents: {
        ...
        maxToolRoundsHint:
          "Combien de fois le modèle peut appeler des outils et lire les résultats avant la fin du tour. Compte les tours, pas les appels individuels.",
        ...
        midSessionUpdatesHint:
          "Laisse l'agent charger le AGENTS.md propre à un sous-dossier la première fois qu'il y travaille. Désactivé, la conversation s'en tient à ce que vous et le modèle y mettez.",
      ...
      tools: {
        ...
        groups: {
          ...
          knowledge: "Connaissances du projet",
          memory: "Mémoire",
          permissions: "Autorisations",
          providers: "Fournisseurs et modèles",
          tasks: "Tâches suggérées",
          voice: "Voix",
        },
      },
      remove: {
      ...
      models: {
        ...
        visibilityLabel: "Afficher {{id}} dans les sélecteurs de modèles",
    ...
    project: {
      ...
      worktree: {
        ...
        uncommittedTitle: "Validez les modifications de otto.json",
    ...
    layout: {
      openInSidePane: {
        ...
        sources: {
          ...
          diffs: {
            label: "Ouvrir une différence",
            description:
              "Ouvrez les différences de l’Explorateur et des conversations d’agent à côté de votre travail",
          },
        },
      },
    },
  ...
  kanban: {
    ...
    project: "Projet",
    board: "Tableau",
    refresh: "Actualiser les tableaux",
    noHostsTitle: "Aucun tableau disponible",
    noHostsBody: "Connectez un hôte avec la fonction Kanban pour voir ses tableaux.",
    noProjectsTitle: "Aucun projet sur cet hôte",
    noProjectsBody: "Ouvrez un projet sur cet hôte pour le suivre sur un tableau.",
    unconfiguredTitle: "Aucun tableau configuré",
    unconfiguredBody: "Choisissez un tableau GitHub ou Jira pour ce projet pour le voir ici.",
    unconfiguredAction: "Ouvrir les paramètres du projet",
    boardError: "Impossible de charger les tableaux",
    remediation: {
      copy: "Copier la commande",
      copied: "commande",
      copyFailed: "Impossible de copier la commande",
      run: "Exécuter dans le terminal",
      runTitle: "Exécuter cette commande ?",
      runMessage:
        "Otto ouvre un terminal dans ce projet et exécute :\n\n{{command}}\n\nVous serez conduit dans ce terminal pour terminer la connexion : un code à usage unique s'affiche et votre navigateur s'ouvre.",
      runConfirm: "Exécuter",
      runCancel: "Annuler",
      terminalTitle: "Connexion GitHub",
      terminalStarted: "Un terminal a été ouvert pour terminer la connexion",
      terminalFailed: "Impossible d'ouvrir un terminal sur cet hôte",
      hint: "Terminez la connexion dans le terminal, puis revenez recharger les tableaux.",
    },
