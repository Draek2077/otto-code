...
const entry = path.join(appRoot, "src/editor/webview/editor-webview-entry.ts");
const output = path.join(appRoot, "src/editor/webview/editor-webview-html.ts");
...
if (!js) {
  throw new Error("editor webview bundle produced no JavaScript");
}
...
const contents = `// Generated by packages/app/scripts/build-editor-webview-html.mjs.
// Do not edit by hand.

export const editorWebViewHtml = ${JSON.stringify(html)};
`;
