import { getOttoToolLeafName, getPaseoToolLeafName } from "./tool-name-normalization.js";
...
export function buildPaseoToolDetailSections(
  ...
  const leafName = getPaseoToolLeafName(toolName) ?? getOttoToolLeafName(toolName);
