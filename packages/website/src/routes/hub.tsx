...
export const Route = createFileRoute("/hub")({
  head: () =>
    pageMeta(
      "Otto Hub - GitHub, Slack, and Discord triggers",
      "Run Otto Hub yourself and start agents on your own machines from GitHub, Slack, and Discord.",
      "/hub",
    ),
  component: Hub,
});
...
function Hub() {
  return (
    <SiteShell width="default">
      <h1 className="text-3xl font-medium tracking-tight mb-4">Otto Hub</h1>
  ...
  return (
    <section className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-4 pt-2">
        ...
        <a
          href="https://github.com/Draek2077/hub"
          target="_blank"
    ...
    <figure className="space-y-3">
      <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02]">
        ...
        <div className="space-y-5 p-5">
          ...
          <DemoMessage author="otto-bot" time="09:41" bot>
          ...
          <DemoMessage author="otto-bot" time="09:48" bot>
            <p>
...
function Mention() {
  return <span className="rounded bg-indigo-400/15 px-1 py-0.5 text-indigo-200">@otto-bot</span>;
}
...
function Access() {
  return (
    <section className="space-y-6">
      ...
      <p className="text-white/70 leading-relaxed max-w-2xl">
        The hosted version is not generally available yet. Join the Otto Discord and watch the
        <span className="font-mono text-white/80"> #otto-hub</span> channel for the release
        announcement.
      </p>
    ...
    <section className="space-y-6">
      ...
      <div className="space-y-6">
        <FAQItem question="What is the Hub?">
          A separate service that sits above your Otto daemons. You connect one or more daemons to
          it and it gives them GitHub, Slack, and Discord triggers, with collaboration features
          planned. Otto works fully without it.
        </FAQItem>
        <FAQItem question="Why is it a separate service instead of part of the daemon?">
          <p>
            ...
            same RPCs the app and the CLI use, so anyone can build their own hub on top of Otto.
          </p>
          <p>
        ...
        <FAQItem question="Can I run it myself?">
          Yes. Run <code>npx @otto-code/hub</code> and complete setup in the browser. The source is
          available on{" "}
          <a href="https://github.com/Draek2077/hub" className={LINK_CLASS}>
            GitHub
          </a>
          , and the{" "}
        ...
        <FAQItem question="What do I need to run it?">
          Node.js and a running Otto daemon. Hub guides you through connecting the provider apps you
          want.
        </FAQItem>
        <FAQItem question="Will there be a hosted version?">
          Yes. Join the Otto Discord and watch the <code>#otto-hub</code> channel. The hosted
        ...
        <FAQItem question="Do I have to move my team to a new tool?">
          ...
          already run. When the work gets serious you switch to the Otto app on those same daemons.
        </FAQItem>
        ...
        <FAQItem question="How do I get access?">
          ...
          and wait for the release announcement in <code>#otto-hub</code>. You do not need to
