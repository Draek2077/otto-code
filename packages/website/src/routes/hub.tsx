...
export const Route = createFileRoute("/hub")({
  head: () =>
    pageMeta(
      ...
      "An optional service above your Otto daemons. Mention a bot in a GitHub issue and an agent runs on your own machine and opens a PR. Self-hosted first, private beta.",
      "/hub",
    ),
  component: Hub,
});
...
function Access() {
  return (
    <section className="space-y-6">
      ...
      <p className="text-white/70 leading-relaxed max-w-2xl">
        Join the Otto Discord and DM me. I&apos;m looking for design partners who are comfortable
        self-hosting.
      </p>
    ...
    <section className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        <FAQItem question="Why self-hosted first?">
          ...
          and it applies to every Otto user.
        </FAQItem>
