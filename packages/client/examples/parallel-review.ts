import type { OttoAgentHandle, OttoClient } from "@otto-code/client";

export async function reviewInParallel(client: OttoClient, cwd: string): Promise<string[]> {
  const agents: OttoAgentHandle[] = [];
