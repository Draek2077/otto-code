...
// Protocol support belongs to the installed client. Browser hosting and Brain log watching need
// a resource owner supplied by the caller. Keep this exhaustive as the protocol evolves.
export const DEFAULT_CLIENT_CAPABILITIES = {
  ...
  // Brain log watching is declared by the host runtime that owns watch demand.
} satisfies Record<
  Exclude<ClientCapability, typeof CLIENT_CAPS.browserHost | typeof CLIENT_CAPS.brainLogWatch>,
  true
>;
