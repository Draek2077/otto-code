...
const BUILT_IN_EDITOR_TARGETS: readonly EditorTargetDefinition[] = [
  ...
  { id: "intellij-idea", label: "IntelliJ IDEA", kind: "editor", command: "idea" },
  { id: "pycharm", label: "PyCharm", kind: "editor", command: "pycharm" },
  { id: "phpstorm", label: "PhpStorm", kind: "editor", command: "phpstorm" },
  { id: "rubymine", label: "RubyMine", kind: "editor", command: "rubymine" },
  { id: "clion", label: "CLion", kind: "editor", command: "clion" },
  { id: "goland", label: "GoLand", kind: "editor", command: "goland" },
  { id: "rider", label: "Rider", kind: "editor", command: "rider" },
  { id: "rustrover", label: "RustRover", kind: "editor", command: "rustrover" },
...
// Only the argument needs converting â€” CreateProcess resolves the command path
