...
const MANIFEST_OWNER = "otto-skills-transaction";
const MANIFEST_FILENAME = "transaction.json";
const TRANSACTION_PREFIX = ".otto-skills-transaction-";
const RECOVERED_PREFIX = ".otto-skills-recovered-";
const BACKUP_DIRNAME = "backup";
const MANAGED_FILES_MANIFEST = ".otto-managed-files.json";
