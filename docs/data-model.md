...
| `labels`             | `Record<string, string>`                 | Key-value labels (default `{}`). `otto.parent-agent-id` is set automatically for `create_agent` subagent relationships - see [chat-lifecycle.md](./chat-lifecycle.md)                                                                                                                                                                                                               |
...
**Path:** `$OTTO_HOME/chat/rooms.json`
...
**Path:** `$OTTO_HOME/loops/loops.json`
