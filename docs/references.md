...
| **AsciiDoc / Asciidoctor**                                                                          | **Unevaluated**                          | The format `archdocs/` is authored in. Otto's `.adoc` preview is a hand-written converter to markdown rather than an Asciidoctor dependency — rationale in the module header of `markdown/asciidoc/asciidoc-to-markdown.ts`, behaviour in [markdown-rendering.md](markdown-rendering.md).                                                                                                           |
