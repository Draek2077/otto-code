...
| **[Mermaid](https://mermaid.js.org)**                                                               | **Dependency** (lazy + vendored webview) | Diagram fences on all four platforms. Web/Electron import it lazily (~3.4 MB); iOS/Android run the same render core in a self-contained webview payload. Also the diagram layer of `archdocs/`.                                                                                                                                                                                                     |
...
| **AsciiDoc / Asciidoctor**                                                                          | **Unevaluated**                          | The format `archdocs/` is authored in, and the subject of an in-flight file-viewer preview (`projects/file-rendering/asciidoc-preview.md`).                                                                                                                                                                                                                                                         |
...
| **[Playwright](https://playwright.dev)**                         | **Dependency**              | The E2E harness across all three QA tiers, and the marketing-site demo capture pipeline (`projects/site-demos/`).                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
