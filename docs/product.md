...
- MCP server exposes the daemon to other agents (create_chat by Personality, list_personalities, send_chat_prompt, schedules, terminals, worktrees, workspace renaming)
