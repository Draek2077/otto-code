...
| alternate screen    | Existing PTY/headless xterm probe enters and exits an alternate screen | The app-level real Vim and alternate-screen behavior remains covered by `terminal-alternate-screen.spec.ts`.                                      |
