...
| [`findings/`](../findings/README.md) | Dated investigation reports: what was measured, how, and what it ruled out                            | Past - _this is what we measured_     |
...
| [project-knowledge.md](project-knowledge.md)                             | Repo-owned durable facts, project charters with delivery metrics, and evaluated references - lifecycles, daemon tools, discovery, migration, and management UI                                                                                                                                                                                                                                                                                                                                                               |
...
| [brain.md](brain.md)                       | Otto Brain - the `/__host/*` management API, why the daemon **proxies rather than shells out** (so a remote brain is not second class), two-level capability negotiation, the `allowRemoteConfig` write gate, the hosting profile's three empirical warnings, the four calibration states, and the rail button's state machine (**a state is only shown when a signal for it exists**) with its measured badge geometry |
