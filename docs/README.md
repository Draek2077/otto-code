...
| [chat-scrolling.md](chat-scrolling.md)   | Transcript scroll position: while the reader holds it the app writes nothing, detach is decided from the scroll event and never the input device, plus the scroll anchor    |
