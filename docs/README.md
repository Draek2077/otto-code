...
| Page                                                                     | What's in it                                                                                                                                                                                                                                                                                                                 |
| ------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [chat-lifecycle.md](chat-lifecycle.md)                                   | Chat states, delivery (Interrupt vs Queue for a busy agent), parent/child relationships, archive **and delete** semantics (delete removes Otto's record only — provider transcripts stay), tabs vs archive, the subagents track, the Background Tasks track. **A chat is the wrapper; an agent is the AI session inside it** |
