...
and are built there, not separately. **GitHub alerts and HTML `<table>` have shipped**; math
(KaTeX), footnotes and interactive checkboxes remain. A live-preview editor that cannot render math
is not a live-preview editor, so they stopped being optional._
