...
and are built there, not separately. **GitHub alerts, HTML `<table>`, footnotes and interactive
checkboxes have shipped**; math (KaTeX) remains. A live-preview editor that cannot render math is
not a live-preview editor, so it stopped being optional._
