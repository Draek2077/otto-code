...
updated_at: "2026-08-21T15:36:40.956Z"
---
# Sidebar Active Team switcher is centered

<!-- compiled_truth -->

When the Active Team switcher is placed in the left sidebar, its full-width trigger and touch target remain full width. In the two-column sidebar-navigation layout, the trigger’s icon-and-label content is centered within that width. When the layout collapses to one column, the content returns to left alignment with History and the navigation rows. The title-bar placement keeps its existing alignment.
