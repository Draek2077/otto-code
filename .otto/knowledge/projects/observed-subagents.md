...
## Companion document: provider-adapters.md
...
- time: "2026-08-08T06:17:57.301Z"
  kind: "decision"
  summary: "Knowledge page created."
- time: "2026-08-08T06:17:57.301Z"
  kind: "evidence"
  summary: "Migrated from `projects/observed-subagents/observed-subagents.md` and the legacy `projects/README.md` ledger. Legacy status: Partial. Ledger summary: Provider subagents promoted to read-only track rows. Claude proof shipped; generalizing is adapter-only work. **[provider-adapters.md](observed-subagents/provider-adapters.md) is the adapter contract** and is cited from `docs/`"
