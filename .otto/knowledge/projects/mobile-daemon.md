...
created_at: "2026-08-08T06:17:56.643Z"
updated_at: "2026-08-08T06:19:48.520Z"
---
...
**Status:** Charter - thought-experiment stage, drafted 2026-07-12. Not yet started. Two prerequisites gate the build: the [session-decomposition](../../archive/projects/session-decomposition/session-decomposition-plan.md) core/host boundary work and (product pairing, not a hard blocker) [interface-modes](../../docs/onboarding.md).
...
| Session decomposition                | [session-decomposition-plan.md](../../archive/projects/session-decomposition/session-decomposition-plan.md) - per-domain controllers with narrow Host seams | The controller boundaries ARE the core/host sort; voice/checkout carves shipped    |
| User mode surface reduction          | [interface-modes.md](../../docs/onboarding.md) - dev surfaces hidden, chat-first lens                                                                       | The User-mode hidden set ≈ the capabilities the embedded daemon lacks anyway       |
...
- time: "2026-08-08T06:17:56.643Z"
  kind: "decision"
  summary: "Knowledge page created."
- time: "2026-08-08T06:17:56.643Z"
  kind: "evidence"
  summary: "Migrated from `projects/mobile-daemon/mobile-daemon.md` and the legacy `projects/README.md` ledger. Legacy status: Charter. Ledger summary: Embedded API-native daemon on the phone (\"This device\" host); no CLIs"
- time: "2026-08-08T06:19:48.520Z"
  kind: "note"
