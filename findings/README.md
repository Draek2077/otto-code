...
| ------------------------------------------------------------------------------------------- | ---------- | -------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [client-performance](client-performance/2026-07-25-fps-degradation.md)                      | 2026-07-25 | Why does app-wide FPS degrade the longer Otto stays open, while the Visualizer stays smooth? | No classic leak. Retained mounted workspace trees + navigation refetch. Timer leak, cache growth and message-decode cost all retired by measurement                                                                    |
