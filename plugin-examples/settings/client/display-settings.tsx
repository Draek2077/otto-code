...
import { useSettings, type PluginSurfaceProps } from "@otto-code/plugin/client";
import type { SettingsState } from "@otto-code/plugin/client";
import {
  SettingsAction,
  SettingsCard,
  SettingsInput,
  ...
  SettingsSelect,
  SettingsSwitch,
} from "@otto-code/plugin/client/ui";
