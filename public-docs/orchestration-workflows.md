...
description: Copyable prompts for delegating, parallelizing, reviewing, and continuing agent work with Otto.
...
```text
Stay as the orchestrator. Use Otto to find the available Codex 5.6 model, then
...
```text
Create three Otto subagents in this workspace. Have one trace the request path,
...
```text
Split these two issues between two Otto subagents. Create a separate workspace
...
```text
Use Otto to create a heartbeat every 10 minutes. Continue this migration in
