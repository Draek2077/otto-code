...
description: Create and manage Otto schedules with otto schedule.
nav: CLI
order: 27
category: Schedules
---
...
`otto schedule` creates and manages [schedules](/docs/schedules) from your terminal, useful for headless boxes and scripts.
