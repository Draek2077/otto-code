...
```
/otto-loop keep trying until the changed test file passes, max 5 iterations
/otto-loop babysit PR 123 until checks are green, check every 2m, max-time 1h
```
