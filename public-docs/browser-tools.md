---
title: Browser tools
description: The browser_* MCP tools agents use to drive Otto browser tabs.
nav: Tools reference
order: 37
category: Browser
---
...
The `browser_*` tools are injected into agents alongside the other [Otto MCP tools](/docs/mcp) when [browser automation](/docs/browser) is enabled.
...
| `browser_hover`    | `browserId, ref`                                    | Hover an element, triggering real CSS `:hover`.                                      |
