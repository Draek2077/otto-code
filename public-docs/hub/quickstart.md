...
description: "Upstream Paseo Hub reference. Run Hub locally and answer a Slack mention with an agent on your machine."
nav: Quickstart
order: 61
category: Hub
---
...
You need [Paseo installation documentation](https://paseo.sh/docs), Node.js, and a Slack workspace where you can create an app.
