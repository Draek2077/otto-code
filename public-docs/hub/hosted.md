---
title: Hosted Hub
description: Sign in to the managed Otto Hub or self-host the same service.
nav: Hosted
order: 73
category: Hub
---
...
[Otto Hub](https://hub.otto-code.me) is the managed service. It is not generally available yet: existing accounts can sign in, but new account registration is closed.
