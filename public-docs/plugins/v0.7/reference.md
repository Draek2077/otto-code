...
> **Historical Paseo v0.7 API.** These mixed-entry declarations do not describe the current Otto runtime. For current authoring, use the [v0.8 guide](/docs/plugins/v0.8) and [migration checklist](/docs/plugins/v0.8/migration).
