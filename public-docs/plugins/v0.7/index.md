...
> **Historical Paseo v0.7 API.** This page preserves the old mixed-entry examples for migration.
> For the API integrated into Otto, use the [current v0.8 guide](/docs/plugins/v0.8) and
> [entry migration guide](/docs/plugins/v0.8/migration).
